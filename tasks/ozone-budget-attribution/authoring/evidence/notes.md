...
is not a search through a large filesystem. The archive is 27 MB in seventeen
...
It is also not an unresolved historical question dressed up as one with an
invented unique answer. What is graded is a defined, checkable property of four
simulations that exist only in this bundle.
