"""Numerical validation of the Problem 3 archive.  Writes validation.md.
...
4. analytic cases: closed-box chemistry, pure transport, deposition only, and
   the prescribed mask-motion example from the problem specification;
...
def analytic_cases():
    ...
    # Prescribed mask motion, the worked example from the specification.
